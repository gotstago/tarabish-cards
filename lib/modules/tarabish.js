    ...
    var myGame = function () {
      ...
      function deal(amount, repeat = 1) {
        return new Promise(function (resolve, reject) {
          ...
          var currentCard
          for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++) {//4
            for (var amountIndex = 0; amountIndex < amount; amountIndex++) {//3
              console.log('here')
      ...
      function dealBidCard(card,i) {
        return new Promise(function (resolve, reject) {
          ...
          card.animateTo({
            ...
            y: positions[playerPositions[currentPosition]].getY(i, fontSize),//Math.round((i - 1.05) * 20 * fontSize / 16),
            x: positions[playerPositions[currentPosition]].getX(i, fontSize),//Math.round(-150 * fontSize / 16),
